  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-3xl mx-auto">
        <h1 className="text-3xl font-bold text-center text-gray-900 mb-8">Barcode Scanner</h1>
        ...
        {scannedBarcode && (
          <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
            <div className="flex">
              ...
              <div className="ml-3">
                <h3 className="text-sm font-medium text-green-800">Barcode Scanned Successfully!</h3>
                <div className="mt-2 text-sm text-green-700">
                  <p>Scanned Code: <span className="font-mono bg-green-100 px-2 py-1 rounded">{scannedBarcode}</span></p>
                </div>
              </div>
            </div>
          </div>
